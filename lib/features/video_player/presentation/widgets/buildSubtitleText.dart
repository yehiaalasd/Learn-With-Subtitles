...
import 'package:mxplayer/features/video_player/presentation/widgets/buildWordButtons.dart';
...
class SubtitleText extends StatefulWidget {
  ...
  const SubtitleText({super.key, required this.model});
            ...
            IconButton(
              onPressed: () {
                if (currentSubtitle.isShowOriginalSubtitle) {
                  currentSubtitle.removeKnownWordsFromSubtitles(provider);
                }
